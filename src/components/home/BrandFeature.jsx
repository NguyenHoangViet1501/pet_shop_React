        ...
        <div id="brandCarousel" className="carousel slide rounded-4 overflow-hidden shadow-sm" data-bs-ride="carousel" data-bs-interval="2000">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active" data-bs-interval="2000">
              <img src="/images/Gemini_Generated_Image_2c63vq2c63vq2c63.png" className="d-block w-100" alt="Brand 1" style={{ height: '400px', objectFit: 'cover' }} />
            </div>
            <div className="carousel-item" data-bs-interval="2000">
              <img src="/images/Gemini_Generated_Image_ksrwrksrwrksrwrk.png" className="d-block w-100" alt="Brand 2" style={{ height: '400px', objectFit: 'cover' }} />
            </div>
            <div className="carousel-item" data-bs-interval="2000">
              <img src="/images/unnamed.jpg" className="d-block w-100" alt="Brand 3" style={{ height: '400px', objectFit: 'cover' }} />
            </div>
          </div>
        </div>
      </div>
